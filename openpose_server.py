...
try:
    ...
    try:
        ...
        if platform == "win32":
            ...
            # Change these variables to point to the correct folder (Release/x64 etc.)
            sys.path.append('/home/ines/Desktop/ITI-ISR-Summer-Internship-2023/openpose/build/python')
    ...
    opWrapper.start()
    container = connect_kinova_camera("ws://10.16.144.217:81/video") 
    ...
    while not userWantsToExit:
        ...
        frame = get_next_frame(container)
        datum = op.Datum()
        ...
        if turn_n >= len(turn_order) - 1:
            ...
            if checkStatus == 0:
                if checkArmExtendedLeft(datumProcessed, left_id):
                    action_flag = True
                ...
                if checkArmRetractedLeft(datumProcessed, left_id):
                    action_flag = True
            ...
            if checkStatus == 0:
                if checkArmExtendedRight(datumProcessed, right_id):
                    action_flag = True
                ...
                if checkArmRetractedRight(datumProcessed, right_id):
                    action_flag = True
